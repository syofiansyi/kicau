        ...
        @php
            $socials = [
                [
                    ...
                    'bg' => '#dcfce7',
                    'hoverBg' => '#bbf7d0',
                    'link' => 'https://wa.me/6285886212454',
                ],
                [
                    'icon' => 'tiktok',
                    'bg' => '#f3f4f6',
                ...
                @switch($s['icon'])
                    @case('facebook')
                        <svg class="w-8 h-8" viewBox="0 0 24 24">
                            <path fill="#1877F2" d="M22 12a10 10 0 1 0-11.6 9.9v-7h-2.8V12h2.8V9.8
                    ...
                    @case('instagram')
                        <svg class="w-8 h-8" viewBox="0 0 24 24">
                            ...
                            <path fill="url(#ig)" d="M7 2C4.2 2 2 4.2 2 7v10c0 2.8 2.2 5 5 5h10
                    ...
                    @case('youtube')
                        <svg class="w-8 h-8" viewBox="0 0 24 24">
                            <path fill="#FF0000" d="M23.5 6.2s-.2-1.6-.9-2.3
                                                                                  c-.8-.9-1.7-.9-2.1-1
