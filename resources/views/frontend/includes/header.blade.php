...
<div id="kt_header" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <a >
                <img alt="Logo" src="{{ asset('Frontend/img/logo.png') }}" class="h-20px h-lg-30px app-sidebar-logo-default">
            </a>
        </div>
            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav"><div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}" style="">
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        <div class="menu-item me-lg-1">
                            <a class="menu-link {{ $route == 'home' ? 'active' : '' }} py-3" href="{{ route('home') }}">
                                <span class="menu-title">Home</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link  {{ Str::contains(request()->url(), 'artikel_berita') ? 'active' : '' }}  py-3" href="{{ route('artikel_berita') }}">
                                <span class="menu-title">Artikel Berita</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link  {{ Str::contains(request()->url(), 'event') ? 'active' : '' }}  py-3" href="{{ route('event-all') }}">
                                <span class="menu-title">Event</span>
                            </a>
                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link {{ Str::contains(request()->url(), 'jadwal') ? 'active' : '' }} py-3" href="{{ route('pertandingan') }}">
                                <span class="menu-title">Pertandingan</span>
                            </a>

                        </div>
                        <div class="menu-item me-lg-1">
                            <a class="menu-link {{ $route == 'about' ? 'active' : '' }}  py-3" href="{{ route('about') }}">
