...
@section('meta')
    ...
    <meta property="og:image" content="{{ $tips->photo ? asset('Upload/tips/' . $tips->photo) : asset('Frontend/img/logo.png') }}">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-start pt-4">
                        ...
                        <div class="mb-3 mb-md-0 me-md-4">
                            <img src="{{ asset('Upload/tips/' . $tips->photo) }}" alt="Tips Image" class="img-fluid rounded shadow" />
                        </div>
