...
@section('meta')
    ...
    <meta property="og:image" content="{{ $berita->photo ? asset('Upload/news/' . $berita->photo) : asset('Frontend/img/logo.png') }}">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex flex-column  align-items-start pt-4">
                        ...
                        <div class="mb-3 mb-md-0 me-md-4">
                            <img src="{{ asset('Upload/news/' . $berita->photo) }}" alt="Event Image" class="img-fluid rounded shadow" />
                        </div>
