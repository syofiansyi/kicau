        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                ...
                <ul class="nav nav-main">
                    ...
                    @if (Auth::user()->role == 'admin')
                        <li class="nav-parent">
                            <a class="nav-link" href="#">
                                <i class="el el-group" aria-hidden="true"></i>
                                <span>User</span>
                            </a>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            <i class="el el-instagram" aria-hidden="true"></i>
                            <span>Gallery Happening</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('admin.happening') }}">
                                    Gallery Happening All
                                </a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('add.happening') }}">
                                    Add Gallery Happening
                                </a>
                            </li>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            <i class="el el-picasa" aria-hidden="true"></i>
                            <span>Gallery Art</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('art') }}">
                                    Gallery Art All
                                </a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('add.art') }}">
                                    Add Gallery Art
                                </a>
                            </li>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            <i class="el el-lines" aria-hidden="true"></i>
                            <span>Floor</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('floor') }}">
                                    All Floor
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            <i class="el el-puzzle" aria-hidden="true"></i>
                            <span>Category</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            <i class="el el-tags" aria-hidden="true"></i>
                            <span>Brand</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            ...
                            <span>Restoran (Dine)</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('restoran') }}">
                                    All Restoran
                                </a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('add.restoran') }}">
                                    Add Restoran
                                </a>
                            </li>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            ...
                            <span>Member Previllage </span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('previllage') }}">
                                    All Previllage
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-parent">
                        <a class="nav-link" href="#">
                            ...
                            <span>Point Redemtion</span>
                        </a>
                        <ul class="nav nav-children">
                            <li>
                                <a class="nav-link" href="{{ route('redemtion') }}">
                                    All Point
                                </a>
                            </li>
                        </ul>
